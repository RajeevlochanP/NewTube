...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    loadProfile();
  }, [userStore.profileFetched, dispatch]);

  const handleUsernameEdit = () => {
    setIsEditingUsername(true);
    setNewUsername(userStore.username);
  };
        ...
        <div className={styles.profileCard}>
          <div className={styles.profileHeader}>
            ...
            <div className={styles.profileInfo}>
                ...
                {isEditingUsername ? (
                  <div className={styles.editUsername}>
                    ...
                    <div className={styles.editButtons}>
                      <button onClick={handleUsernameSave} className={styles.saveButton} disabled={isSavingUsername}>
                        {isSavingUsername ? 'Saving...' : 'Save'}
                      </button>
                      <button onClick={handleUsernameCancel} className={styles.cancelButton} disabled={isSavingUsername}>Cancel</button>
                    </div>
                  </div>
                ) : (
                  <div className={styles.usernameDisplay}>
                    <h2 className={styles.username}>{userStore.username || 'User'}</h2>
              ...
              <p className={styles.email}>{userStore.email || 'No email provided'}</p>
              {/* <p className={styles.joinDate}>Member since {userStore.joinDate || 'Unknown'}</p> */}
            </div>
          </div>
        </div>
